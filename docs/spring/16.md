...
Spring MessageSource 教程展示了如何在 Spring 应用程序中使用 MessageSource 转换消息。
...
以下应用程序包含英语和德语消息。 它使用内置的`ResourceBundleMessageSource`。
...
在本教程中，我们展示了如何在 Spring 应用程序中使用`ResourceBundleMessageSource`。
