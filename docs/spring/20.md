...
Spring context：property-placeholder 教程展示了如何使用 context：property-placeholder 标记来外部化 Spring 应用程序中的属性。
...
该应用程序使用`context:property-placeholder`来配置数据源的属性。
...
这是主要的应用程序类。 它检索`dataSource` bean 并打印其属性。
