...
一个消息框向用户提供简短信息。 一个很好的例子是 CD 刻录应用程序。 CD 刻录完成后，将弹出一个消息框。
...
几乎每个应用程序都有一个典型的“关于”对话框。 通常将其放在“帮助”菜单中。 该对话框的目的是向用户提供有关应用程序名称和版本的基本信息。 过去，这些对话框非常简短。 如今，这些框中的大多数都提供了有关作者的其他信息。 他们感谢其他程序员或文档编写者。 他们还提供有关应用程序许可证的信息。 这些框可以显示公司徽标或应用程序徽标。
...
最好不要在应用程序的代码中放入太多文本。 我们不想使示例过于复杂，因此我们将所有文本放入代码中。 但是在实际程序中，文本应单独放置在文件中。 它有助于我们维护应用程序。 例如，如果我们想将我们的应用程序翻译成其他语言。
...
在下一个示例中，我们创建一个自定义对话框。 图像编辑应用程序可以更改图片的颜色深度。 为了提供这种功能，我们可以创建一个合适的对话框。
