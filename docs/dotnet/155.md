...
ASP.NET Core 是一个跨平台，高性能，开放源代码框架，用于构建现代的，基于云的，Internet 连接的应用程序。 ASP.NET Core 是对传统 ASP.NET 框架的重新设计。 您可以在[使用 ASP Core](https://www.vkinfotek.com/asp-core-erp-software-contents.html) 开发 ERP 软件中找到有关 ASP.NET Core 的更多信息。
