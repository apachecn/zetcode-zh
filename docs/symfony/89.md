...
在下面的示例中，我们创建一个 Symfony Web 应用程序，该应用程序使用 HttpClient 生成请求。 我们使用`HttpClientInterface`注入 HttpClient。
...
我们创建一个新的 Symfony 框架应用程序并安装一些依赖项。
...
我们运行该应用程序并导航到`localhost:8000/data`。
