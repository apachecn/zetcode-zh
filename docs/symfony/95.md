...
Symfony 控制台命令教程介绍了如何在 Symfony 中创建控制台命令。 我们将在控制台应用程序中创建几个命令。
...
Symfony 控制台组件使我们可以创建命令行命令。 控制台命令可用于创建 cronjob，导入，批处理作业或某些支持性任务。 Symfony 控制台命令可以在 Symfony 控制台应用程序或 Web 应用程序中使用。 在本教程中，我们将为控制台应用程序创建命令。

## Symfony 控制台命令示例

在以下示例中，我们使用 Symfony Console 组件创建 Symfony 控制台应用程序。
